...
description: |
  A practical, course-focused guide to using R for applied marketing analytics
  in MKT 4320 at Bowling Green State University. The book emphasizes hands-on
  analysis using the MKT4320BGSU R package.
link-citations: yes
---
...
options(knitr.duplicate.label = "force")
```
...
## What this book is (and is not) {.unnumbered .unlisted}
...
## The MKT4320BGSU package {.unnumbered .unlisted}
...
## A note on updates {.unnumbered .unlisted}
